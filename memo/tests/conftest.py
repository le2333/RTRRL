...
The S3 fixtures are here because the worker tests reach an object store and
something has to stand in for it. They used to be a pytest plugin in a package
both sides installed; only this side ever loaded them.
"""
